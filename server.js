    ...
    if (array.length === 3) {
      ...
      axios.request(options).then(function (response) {
          ...
          if (response.data.status == true) {
              ...
              response_ = transformCommand(req.body.command,"Ikaze kuri Social Registry ^ Umukuru w'urugo: ${resp.data. ${resp.data.resh ^ Kode: ${resp.data yt ^ Ingano : ${resp.d ^ Porogarumu: ${reresponse","C")
